...
from ldm.models.diffusion.ddim import DDIMSampler, make_ddim_timesteps

__conditioning_keys__ = {'concat': 'c_concat',
                         'crossattn': 'c_crossattn',
                         'adm': 'y'}

from scripts.sample_diffusion import load_from_checkpoint
...
class DDPM(pl.LightningModule):
    ...
    def __init__(self,
        ...
        teacher_model, teacher_config, logdir, global_step = load_from_checkpoint(teacher_ckpt, tuple())
...
class DLatentDiffusion(DDPM):
    ...
    @torch.no_grad()
    # TODO: change this to use the current distilled model with current number of jumps
